...
- Действовать от имени человека (бронь, даже бесплатная, заявка, форма,
  заказ) запуск может только с `allowSubmit`; без него в поручение не
  попадают имя, телефон, почта и адреса. Раньше инструкции велели запуску
  самому доводить «всё бесплатное»: так просьба посоветовать ресторан
  бронировала столик, а сборка шкафа оставляла заявку на Profi.ru с телефоном.
  Самостоятельность из #171 (бесплатная бронь без вопроса) действует, только
  когда человек сам попросил забронировать; рекомендация, его данные на чужом
  сайте и пачка изменений в почте — раздел «Где самостоятельность кончается»
  в `agent/instructions/content/autonomy.md`.
