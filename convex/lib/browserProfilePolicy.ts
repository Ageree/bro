...
Дальше жди. Человек сам введёт логин, пароль и код через live-view.
Не вводи логин, пароль и код из SMS сам. Не подтверждай форму входа, пока человек не ввёл данные.
