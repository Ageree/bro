 ...
 *
 * Lives in convex/lib (not agent/lib) because a purchase that finishes in the
 * background is recorded from the Convex follow-through, and Convex code never
 * imports from agent/. `agent/lib/order-policy.ts` re-exports this module, so
