import type { ComputerBatchParams } from "@onkernel/sdk/resources/browsers";
import { defineTool, toolOutput, toolOutputPart } from "eve/tools";
import { z } from "zod";
import { kernel } from "../lib/kernel";
import { withVaultScreenshotMask } from "../lib/screenshot-mask";
...
export default defineTool({
  ...
  async execute(input, ctx) {
    ...
    // Actions must run in the given order; flush the batch at each observation.
