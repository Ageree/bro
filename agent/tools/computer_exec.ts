...
export default defineTool({
  description:
    "Run a shell command on this person's Linux computer (/home/user). Network allowed. Not for shopping or clinic sites — use browser_task. Group chats cannot use the computer.",
