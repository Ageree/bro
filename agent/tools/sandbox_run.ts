...
export default defineTool({
  description:
    "Work with this person's files: convert, OCR, extract text, build a PDF or table, resize images. Stages selected files, runs a command or script, and keeps the results. Not for websites — use browser_task.",
