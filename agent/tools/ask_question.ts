 ...
 * («use this when you need clarification or a choice») had
 * `openai/gpt-6-luna` confirm what the person had just asked for: «Сохранить
 * их?» after «запомни», «Какие действия выполнить?» after three explicit
 * requests. The approval card of an action is its one confirmation.
 */
