...
/** In-turn wait after start or poll. Notify already went out; follow-through
 *  watches the run, so this only buys a cheap in-turn complete. "ну что" polls
 *  should not park the model for 12s. */
