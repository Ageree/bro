...
// become a backdoor way to fetch websites — facts go through TinyFish,
// shops and forms through browser_task.

export const SANDBOX_NETWORK_RULE =
  "Сеть из sandbox запрещена: факты — web_search / web_fetch, магазины и формы — browser_task";
