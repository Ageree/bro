...
- Если человек называет свой город/страну или просит бриф «по моему времени» — вызови `set_timezone` (IANA, например `Asia/Vladivostok`).
- При первом `schedule_wakeup`, если таймзона ещё неизвестна, один раз спроси.
