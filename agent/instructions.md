...
Если спрашивают про личный кабинет, вход в кабинет, подписку/лимиты или хотят добавить карту — `cabinet_link` и пришли `url` из ответа. Не спрашивай хендл и код. Ссылка работает 10 минут на любом устройстве.
