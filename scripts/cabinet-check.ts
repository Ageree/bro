...
assert(cabinet.includes('class="doc-title">Кабинет</h1>'), "cabinet title is Prata like vault");
assert(!cabinet.includes("handle-xl"), "cabinet title is not the old handle gothic");
