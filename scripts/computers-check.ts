...
assert.match(computersSrc, /export const startsTodayForAgent/, "computers.startsTodayForAgent");
assert.match(computersSrc, /export const resetStartsForAgent/, "computers.resetStartsForAgent");
assert.doesNotMatch(
  computersSrc,
