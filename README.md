...
> automatically provisions and connects Postgres, private Blob storage, Linq,
> and Vercel AI Gateway access. OpenInstinct creates its installation
...
secrets. It also creates and attaches a [Linq](https://linq.app) connector for
iMessage. Vercel AI Gateway handles inference. Usage is billed to your Vercel
...
Blob, and Linq configuration, so the deploy flow requires no
...
Built on [Vercel](https://vercel.com) · [Linq](https://linq.app) · [Neon](https://neon.tech)
